...
A bilingual English–Simplified Chinese portfolio for Taehyun Kim, built with Astro, Tailwind CSS, Markdown content collections, and the Dante Astro theme. Its navy, sky-blue, and teal palette is inspired by the University of Wollongong.

The language button in the top-right switches the complete interface between English and Simplified Chinese. The selection is saved in the visitor's browser.
...
- Global colours and language visibility rules: `src/styles/global.css`
- Language switch behaviour: `public/language-toggle.js`
